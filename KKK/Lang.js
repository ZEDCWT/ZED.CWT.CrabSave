...
module.exports =
{
	...
	HintEmpty : Lang('No available suggestions'),
	...
	ReadyInfo : Lang('Ready to resolve infomation'),
	GetInfo : Lang('Resolving infomation...'),
	ReadySize : Lang('Ready to resolve sizes'),
	GetSize : Lang('Resolving sizes...'),
	...
	ProxyURL : Lang('Proxy URL'),
	ProxyURLHint : Lang('eg. 127.0.0.1:2124'),
	Yes : Lang('Yes'),
	No : Lang('No'),
	Font : Lang('Font'),
	Size : Lang('Font size'),
